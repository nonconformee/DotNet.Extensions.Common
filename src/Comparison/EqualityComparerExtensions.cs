...
/// <summary>
/// Provides extension methods for <see cref="IEqualityComparer{T}"/> and <see cref="IEqualityComparer"/>.
/// </summary>
public static class EqualityComparerExtensions
{
    ...
    /// <summary>
    /// Creates an <see cref="IEqualityComparer"/> from a function that compares two objects for equality.
    /// </summary>
    ...
    public static IEqualityComparer ToEqualityComparer(this Func<object?, object?, bool> equals, Func<object?, int>? getHashCode = null)
    {
        if (equals is null) throw new ArgumentNullException(nameof(equals));

        return new FuncEqualityComparer<object>(equals, getHashCode ?? (x => x?.GetHashCode() ?? 0));
    }
    ...
    /// <summary>
    /// Converts an <see cref="IEqualityComparer"/> to a function that compares two objects for equality.
    /// </summary>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="comparer"/> is <see langword="null"/>.</exception>
    public static Func<object?, object?, bool> ToEqualityComparerFunc(this IEqualityComparer comparer)
    {
        if (comparer is null) throw new ArgumentNullException(nameof(comparer));
    ...
    public static IEqualityComparer Invert(this IEqualityComparer comparer)
    {
        ...
        return new InvertedEqualityComparer<object>(comparer.ToGeneric<object>());
    }
        ...
        : IEqualityComparer<T>, IEqualityComparer
    {
        ...
        public int GetHashCode(T? obj) => obj is null ? 0 : _comparer.GetHashCode(obj);

        bool IEqualityComparer.Equals(object? x, object? y) => Equals((T?)x, (T?)y);
        int IEqualityComparer.GetHashCode(object? obj) => obj is null ? 0 : GetHashCode((T?)obj);
    }
